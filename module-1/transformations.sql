...
-- Important note
-- The database in the practice changes to Snowflake Public Data (Free), so we need to adjust the code to reflect that. The tables will be created in the SNOWFLAKE_PUBLIC_DATA_FREE.PUBLIC_DATA_FREE schema.
